...
export const ABOUT_HIGHLIGHTS = [
  {
    ...
    description:
      "Expert in building scalable mobile and web applications from the ground up, covering both frontend and backend development.",
    color: "#00d4ff",
  },
  {
    title: "Product Analytics Mindset",
    description:
      "Integrating A/B testing, event tracking, and data-driven decision-making to improve user experience and business outcomes.",
    color: "#8a2be2",
  },
  {
    title: "Business Value Focus",
    description:
      "Mission-driven approach to ensure applications deliver measurable value to users and businesses, not just technical solutions.",
    color: "#00ffff",
  },
  {
    title: "Performance Optimization",
    description:
      "Specialized in frontend performance optimization and design systems for enhanced user experiences.",
    color: "#ff0080",
  },
];
...
export const PROJECTS = [
  ...
  },
  {
    ...
    description:
      "Real-time monitoring dashboard for quantum computing systems with cyberpunk-inspired design.",
  ...
  },
  {
    ...
    description:
      "Decentralized application for exploring blockchain transactions with advanced analytics.",
  ...
  },
  {
    ...
    description:
      "Centralized platform for monitoring and responding to cybersecurity threats in real-time.",
...
export const SERVICES = [
  {
    title: "Full-Stack Development",
    description:
      "End-to-end web & mobile applications built with modern frameworks. From React frontends to scalable backend APIs.",
    features: [
      "React/Next.js",
      "Node.js APIs",
      "Mobile Apps",
  ...
  },
  {
    ...
    description:
      "Data-driven insights & tracking implementation. A/B testing, user behavior analysis, and performance metrics.",
    features: [
      "A/B Testing",
      "Event Tracking",
      "User Analytics",
  ...
  },
  {
    ...
    description:
      "Redis caching, Azure cloud solutions, and robust API design for applications that grow with your business.",
    features: [
  ...
  },
  {
    ...
    description:
      "Modern, accessible, user-focused interfaces. Design systems, responsive layouts, and exceptional user experiences.",
    features: [
      "Design Systems",
      "Responsive Design",
      "Accessibility",
