...
export const ContactSection = () => {
  const socialLinks = [
    ...
    },
    {
      label: "resume",
      icon: <ResumeIcon />,
      href: "https://drive.google.com/file/d/1NUWBTWTUXOFJmAJrZubz0qxywEfu-G77/view?usp=drive_link",
      color: "#8a2be2",
    },
    {
      label: "mail",
      ...
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl mb-4">
            ...
            <span className="text-white ml-2 text-3xl font-normal sm:text-4xl">
              contact
            </span>
          </h2>
